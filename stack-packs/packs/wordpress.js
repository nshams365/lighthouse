...
const UIStrings = {
  ...
  /** Additional description of a Lighthouse audit that tells the user *how* they can improve performance by encoding animationg in HTML5, in the context of the Wordpress CMS platform. This is displayed after a user expands the section to see more. No character length limits. Links in (parenthesis) become link texts to additional documentation. */
